...
def init_scripts(site):
    ...
    simple_scripts = {
	    ...
	    'autoreg en':[     (False, "Welcome to Ureport Burundi, where you can SHARE and RECEIVE information about what is happening in your community. It’s FREE!", ScriptStep.WAIT_MOVEON, 0, False, False, 0,),
                           ...
                           (Poll.TYPE_TEXT, 'reporter_name', "What is your name or nickname? User profiles help us make sense of the data that we receive.  Your name will not be revealed without your permission.", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0,),
                           (Poll.TYPE_NUMERIC, 'reporter_age', "What is your age?", ScriptStep.STRICT_MOVEON, 0, 86400, 86400, 3,),
                           (Poll.TYPE_TEXT, 'reporter_gender', "Are you male or female? Type F for 'female' and M for 'male'", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0, {"male":["m", "mal", "male", "ma", "mas", "masculin", "umugabo", "ga", "gabo", "gab"], "female": ["f", "fem", "female", "fe", "fém" "féminin", "fé", "umugore", "gore", "go", "gor"]}),
    ...
    script_translations = {
        ...
        'autoreg fr':[     (False, "Bienvenue dans Ureport/Burundi, ou tu peux PARTAGER et RECEVOIR l'information sur ce qui se passe dans ta communauté, C'est GRATUIT!", ScriptStep.WAIT_MOVEON, 0, False, False, 0,),
                           ...
                           (Poll.TYPE_TEXT, 'reporter_name', "Quel est ton nom? Ton profil aide a donner un sens  aux données reçues . Ton nom ne sera pas révélé sans ta permission et tu peux utiliser un surnom.", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0,),
                           (Poll.TYPE_NUMERIC, 'reporter_age', "Quel est ton âge?", ScriptStep.STRICT_MOVEON, 0, 86400, 86400, 3,),
                           (Poll.TYPE_TEXT, 'reporter_gender', "Es-tu de sexe masculin ou féminin? Écris F pour féminin et M pour masculin", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0, {"male":["m", "mas", "masculin", "ma"], "female": ["f", "fem", "fém" "féminin", "fé"]}),
        ...
        'autoreg ki':[     (False, "Kaze muri Ureport/Burundi, aho ushobora gutanga no kuronka inkuru ku bibera mu karere uherereyemwo, Ni KU BUNTU!", ScriptStep.WAIT_MOVEON, 0, False, False, 0,),
                           ...
                           (Poll.TYPE_TEXT, 'reporter_name', "Tanga izina ryawe, ibikuranga bifasha guha insiguro inkuru turonse. Izina ryawe ntituritanga utaduhaye uruhusha kandi ushobora gutanga amatazirano", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0,),
                           (Poll.TYPE_NUMERIC, 'reporter_age', "Ufise imyaka ingahe?", ScriptStep.STRICT_MOVEON, 0, 86400, 86400, 3,),
                           (Poll.TYPE_TEXT, 'reporter_gender', "Woba uri uw'igitsina Gore canke igitsina Gabo? Andika Go ari igitsina Gore Na Ga ari igitsina Gabo.", ScriptStep.WAIT_MOVEON, 0, False, 86400, 0, {"male":["umugabo", "ga", "gabo", "gab"], "female": ["umugore", "gore", "go", "gor"]}),
