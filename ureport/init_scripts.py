...
def init_scripts(site):
    ...
    simple_scripts = {
	    ...
	    'autoreg en':[     (False, "Welcome to Ureport Burundi, where you can SHARE and RECEIVE information about what is happening in your community. It’s FREE!", ScriptStep.WAIT_MOVEON, 0, False, 60, 0,),
                           ...
                           (Poll.TYPE_TEXT, 'reporter_name', "What is your name or nickname? User profiles help us make sense of the data that we receive.  Your name will not be revealed without your permission.", ScriptStep.WAIT_MOVEON, 0, False, 3600, 0,),
    ...
    script_translations = {
        ...
        'autoreg fr':[     (False, "Bienvenue dans Ureport/Burundi, ou tu peux PARTAGER et RECEVOIR l'information sur ce qui se passe dans ta communauté, C'est GRATUIT!", ScriptStep.WAIT_MOVEON, 0, False, 60, 0,),
                           ...
                           (Poll.TYPE_TEXT, 'reporter_name', "Quel est ton nom? Ton profil aide a donner un sens  aux données reçues . Ton nom ne sera pas révélé sans ta permission et tu peux utiliser un surnom.", ScriptStep.WAIT_MOVEON, 0, False, 3600, 0,),
                           (Poll.TYPE_NUMERIC, 'reporter_age', "Quel est ton âge?", ScriptStep.STRICT_MOVEON, 0, 3600, 3600, 3,),
